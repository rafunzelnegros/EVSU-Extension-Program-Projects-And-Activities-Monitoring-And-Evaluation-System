...
class UserProfile(models.Model):
    ...
    post_nominals = models.CharField(max_length=120, blank=True, help_text='Optional post-nominal letters, e.g. PhD, MPA, RN')
...
class SustainableDevelopmentGoal(models.Model):
    ppa = models.ForeignKey(PPA, on_delete=models.CASCADE, related_name='sdg_entries')
    order = models.PositiveIntegerField(default=1)
    goal_description = models.CharField(max_length=300)
    target = models.CharField(max_length=300, blank=True)
    description = models.TextField(blank=True)
    indicator = models.CharField(max_length=300, blank=True)
...
class QuarterlyMonitoringReport(models.Model):
    ...
    campus_name = models.CharField(max_length=180, blank=True)
